        ...
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p className="footer-description">
              Stop guessing, start saving. The smart way to find and compare parking prices.
            </p>
          </div>
          ...
          <div className="footer-section">
            ...
            <div className="download-badges">
              <a href="#" className="app-badge">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Download_on_the_App_Store_Badge.svg/640px-Download_on_the_App_Store_Badge.svg.png" alt="Download on App Store" />
              </a>
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              <a href="https://t.me/parq_prices_bot" target="_blank" rel="noopener noreferrer" className="social-link">
          ...
          <div className="footer-section">
            ...
            <a href="mailto:support@parqapp.io" className="contact-email">parq.app.info@gmail.com</a>
          </div>
        </div>
